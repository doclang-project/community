...
The DocLang project is licensed under the Apache License, Version 2.0 — see [LICENSE](./LICENSE). Each source file must include a license header. Using the SPDX format is the simplest approach, e.g.:

```py
# SPDX-License-Identifier: Apache-2.0
# Copyright © The DocLang Authors
```

Contributions are also subject to the project [IP Policy](./IP-POLICY.md), which describes the patent grant and contribution licensing terms required for an ISO-track standard.
